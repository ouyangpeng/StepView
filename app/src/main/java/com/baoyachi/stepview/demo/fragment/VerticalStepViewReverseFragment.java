...
public class VerticalStepViewReverseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = View.inflate(getActivity(), R.layout.fragment_vertical_stepview, null);
        return mView;
    }
    ...
    public void onStart() {
        super.onStart();
        mStepView = mView.findViewById(R.id.step_view0);
        ...
        //设置完成的步数
        mStepView.setStepsViewIndicatorCompletingPosition(list0.size() - 2)
                //总步骤
